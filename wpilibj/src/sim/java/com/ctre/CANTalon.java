...
/**
 * CTRE CANTalon Speed Controller
 */
public class CANTalon implements SpeedController, PIDOutput, MotorSafety, LiveWindowSendable {
	private int channel;
     ...
     *
     * Note that the CANTalon uses the following bounds for PWM values. These values should work reasonably well for
     * most controllers, but if users experience issues such as asymmetric behavior around
     * the deadband or inability to saturate the controller in either direction, calibration is recommended.
     * The calibration procedure can be found in the CANTalon User Manual available from CTRE.
     *
     ...
     *   - .989ms = full "reverse"
     */
    private void initCANTalon(final int channel) {
     ...
     * Constructor.
     *
     * @param channel The PWM channel that the CANTalon is attached to.
     */
    public CANTalon(final int channel) {
        initCANTalon(channel);
    }
    ...
    public void set(double speed) {
        impl.set(isInverted ? -speed : speed);
    }
